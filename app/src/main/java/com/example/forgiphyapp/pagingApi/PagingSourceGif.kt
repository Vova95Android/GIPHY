...
class PagingSourceGif(val searchData: String, val actualData: List<GifData>, val database: GifDatabaseDao): PagingSource<Int, Data>() {
    var offseData=0
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int,Data> {
        ...
        while (listSize<limitTemp) {
            ...
            if (listDataRemov.size>0)listResultTemp.data=listResultTemp.data.minus(listDataRemov)
